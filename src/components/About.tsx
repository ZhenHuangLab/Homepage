    ...
    <div className="flex flex-col items-start gap-6 lg:gap-8 px-3 lg:px-6 py-4">
      <div className="flex flex-row items-center gap-4">
        ...
        <div className="flex flex-col items-start gap-2">
          <h1 className="font-mono text-lg lg:text-xl">PhD candidate, Tsinghua Univ</h1>
      ...
      I am a PhD candidate from Tsinghua University, China. My research focuses on cryo-EM/ET, especially its computational side. I am interested in exploring the interdisciplinary interface between physics, chemistry, biology, and computer science, and I strive to learn and conduct research at this intersection.
      </div>
